...
//To do: Implementar get de listado de canciones
...
//                     //<h1 class="text-3xl font-bold color-blue">
//                    //  SoundFast
//                     //</h1>
//                 //</div>
...
function buildSongHtml(song) {
    let div = document.createElement('div')
            div.setAttribute('class', "flex hover:bg-slate-100 transition-all cursor-pointer py-3 px-1 gap-5 items-center text-white ")
